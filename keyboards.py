...
def get_main_keyboard(lang):
    buttons = [
        [
            KeyboardButton(text=get_text(lang, "income")),
            KeyboardButton(text=get_text(lang, "expense")),
        ],
        [
            KeyboardButton(text=get_text(lang, "goals")),
            KeyboardButton(text=get_text(lang, "statistics")),
        ],
        [
            KeyboardButton(text="👥 Shared Goals"),
            KeyboardButton(text=get_text(lang, "videos")),
        ],
        [
...
def get_delete_confirmation_keyboard(lang):
    buttons = [
        [
            KeyboardButton(text=get_text(lang, "confirm_yes")),
            KeyboardButton(text=get_text(lang, "confirm_no")),
        ]
    ]
    return ReplyKeyboardMarkup(keyboard=buttons, resize_keyboard=True)
    ...
    buttons = [
        [
            KeyboardButton(
                text="🎮 Играть",
                web_app=WebAppInfo(
                    url="https://u90272585-oss.github.io/student-finance-ai-bot/game.html"
                ),
            )
        ]
    ]
